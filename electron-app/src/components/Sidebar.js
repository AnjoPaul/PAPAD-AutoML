...
const Sidebar = ({
  ...
  useEffect(() => {
    fetch("http://localhost:5000/normal-preprocessing-modules").then(res => res.json()).then(setNormalProcessingModules).catch(err => console.error("Failed to fetch normal modules:", err));
    fetch("http://localhost:5000/domain-based-preprocessing-modules").then(res => res.json()).then(setDomainProcessingModules).catch(err => console.error("Failed to fetch domain modules:", err));
    fetch("http://localhost:5000/model-list").then(res => res.json()).then(setModels).catch(err => console.error("Failed to fetch models:", err));
    fetch("http://localhost:5000/output-options").then(res => res.json()).then(setOutput).catch(err => console.error("Failed to fetch outputs:", err));
  }, []);
  ...
  const handleApprovePlan = async (approvedPlan) => {
    ...
    try {
        const res = await axios.post("http://localhost:5000/execute-approved-plan", formData);
