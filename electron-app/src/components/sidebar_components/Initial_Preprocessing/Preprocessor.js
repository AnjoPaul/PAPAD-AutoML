  ...
  const handlePreprocess = async (type) => {
    ...
    if (type === "domain") {
      ...
      try {
        ...
        const res = await axios.post("http://localhost:5000/generate-medical-plan", formData);
      ...
      try {
        ...
        const res = await axios.post("http://localhost:5000/preprocess-normal", formData);
